...
# note:
# this blur implemented above is a kernal of size n, where each value is 1/n^2.
...
def apply_kernel(image, kernel):
    ...
    neighbor_range = kernel.shape[0] // 2  # this is a variable that tells us how many neighbors we actually look at (ie for a 3x3 kernal, this value should be 1)
