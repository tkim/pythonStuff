...
class TicTacToe:
    ...
    @staticmethod
    def make_board():
        return [' ' for _ in range(9)] # we will use a single list to rep 3x3 board
    ...
    def winner(self, square, letter):
        ...
        if square % 2 == 0:
            diagonal1 = [self.board[i] for i in [0, 4, 8]] #left to right diagnal
            if all ([spot == letter for spot in diagonal1]):
                return True
            diagonal2 = [self.board[i] for i in [2, 4, 6]] #right to left diagnal
