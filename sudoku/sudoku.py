...
def is_valid(puzzle, guess, row, col):
    ...
    # that number must not be repated in the row, column, or 3x3 square that it appears in
...
def solve_sudoku(puzzle):
    ...
    # step1: chose somewhere on the puzzle to make a guess
    ...
    for guess in range(1, 10): # range(1, 10) is 1, 2, 3, ... 9
        ...
        #5 step 5: if not valid or if nothing gets returned true, then we need to backtrack and try a new number
        puzzle[row][col] = -1
